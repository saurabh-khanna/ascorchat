...
Emerging empirical evidence comparing conversational interviewers based on large language models (LLMs) with human interviewers suggests that AI-administered interviews can produce data of comparable quality while offering substantially greater scalability [@wuttke2025ai]. `surveychat` has been developed to support ongoing research programs in survey methodology and experimental social science that employ LLM-based conversational agents as research instruments. The system’s architecture was iteratively refined in response to feedback from survey methodology researchers who required LLM-based instruments that integrate seamlessly with Qualtrics-centered experimental workflows.

The project is designed for reuse across a broad range of social science domains in which controlled conversational experiments or chatbot-mediated structured interviews are increasingly becoming essential. Its open-source nature is intended to facilitate community-driven extensions and adaptations, for example, to support additional API providers, implement alternative participant routing schemes, or enable integration with other survey platforms. The modular system design allows researchers to modify the underlying codebase to address specific research questions or methodological requirements while preserving a standardised interface for participant interaction and data collection.

The project aims to serve as a methodological example for the development of LLM-based research instruments, illustrating a way to balance experimental control, research participant experience, and data quality considerations in the context of conversational agents. By providing a robust, flexible, and user-friendly platform for LLM-based conversational surveys and experiments, `surveychat` seeks to catalyse further empirical research on the design, implementation, and evaluation of AI-mediated survey instruments, thus contributing to the advancement of survey methodology in the era of large language models.
